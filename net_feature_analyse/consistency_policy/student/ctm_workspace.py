...
class CTMWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: CTMPPUnetHybridImagePolicy = hydra.utils.instantiate(cfg.policy) # consistency_policy.student.ctm_policy.CTMPPUnetHybridImagePolicy
        if cfg.training.debug: # default = false
