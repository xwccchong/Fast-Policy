...
from feature_analyse.freq_encoder_utils import Fourier_filter_visual
...
"""
    input_dim=input_dim, # action_dim + obs_feature_dim 10+
    local_cond_dim=None,
...
class ConditionalUnet1D(nn.Module):
    ...
    def forward(self, 
        ...
        return x, encoder_feature, total_energy
