...
3. For setting up the MuJoCo environment, please refer to:[Mujoco Installation]（https://github.com/Liujian1997/Franka_env-Installation/blob/main/Mujoco安装记录.md）
